...
// .wrangler/tmp/bundle-bemWFC/checked-fetch.js
...
// .wrangler/tmp/pages-ZkE7U7/functionsWorker-0.7914685169119637.mjs
...
var onRequest15 = /* @__PURE__ */ __name2(async (context) => {
  ...
  try {
    ...
    for (const target of TARGET_BRANDS) {
      const potential = brandList.filter((b) => {
      ...
      if (potential.length > 0) {
        ...
        if (exact) {
          ...
          candidates.push({ target, candidates: potential.map((p) => ({ name: p.display_brand_name, id: p.brand_id })) });
...
// .wrangler/tmp/bundle-bemWFC/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-bemWFC/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.7914685169119637.js.map
