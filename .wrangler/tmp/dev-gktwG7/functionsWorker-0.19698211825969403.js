...
// .wrangler/tmp/bundle-KSTxXi/checked-fetch.js
...
// .wrangler/tmp/pages-7zaRTv/functionsWorker-0.19698211825969403.mjs
...
__name(errorResponse2, "errorResponse2");
__name2(errorResponse2, "errorResponse");
...
__name(getCorsHeaders2, "getCorsHeaders2");
__name2(getCorsHeaders2, "getCorsHeaders");
...
__name(errorResponse3, "errorResponse3");
__name2(errorResponse3, "errorResponse");
...
__name(getCorsHeaders3, "getCorsHeaders3");
__name2(getCorsHeaders3, "getCorsHeaders");
...
var onRequest4 = /* @__PURE__ */ __name2(async (context) => {
  ...
  if (!accessToken || !shopId) {
    return errorResponse4("access_token and shop_id required", 400);
  }
  try {
    ...
    return errorResponse4(`Sync error: ${error}`, 500);
  }
}, "onRequest");
...
__name2(getItemList, "getItemList");
...
__name2(getItemBaseInfo, "getItemBaseInfo");
...
function jsonResponse3(data, status = 200) {
  return new Response(JSON.stringify(data), { status, headers: { "Content-Type": "application/json", ...getCorsHeaders4() } });
}
__name(jsonResponse3, "jsonResponse3");
__name2(jsonResponse3, "jsonResponse");
function errorResponse4(message, status) {
  return jsonResponse3({ status: "error", message }, status);
}
__name(errorResponse4, "errorResponse4");
__name2(errorResponse4, "errorResponse");
function getCorsHeaders4() {
  return { "Access-Control-Allow-Origin": "*", "Access-Control-Allow-Methods": "POST, OPTIONS", "Access-Control-Allow-Headers": "Content-Type" };
}
__name(getCorsHeaders4, "getCorsHeaders4");
__name2(getCorsHeaders4, "getCorsHeaders");
...
var onRequest5 = /* @__PURE__ */ __name2(async (context) => {
  ...
  try {
    ...
    return errorResponse5(`Error: ${error}`, 500);
  }
}, "onRequest");
async function handleGet3(db, url) {
  ...
  if (shopId) {
    ...
    if (!token) {
      return jsonResponse4({ status: "error", message: "Token not found", data: null });
    }
...
async function handleRefresh(env, url) {
  ...
  if (!current || !current.refresh_token) {
    return errorResponse5("No refresh token found", 404);
  }
...
__name2(handleRefresh, "handleRefresh");
async function handleDelete3(db, url) {
  ...
  return jsonResponse4({ status: "success", message: "Token deleted" });
}
...
function jsonResponse4(data, status = 200) {
  return new Response(JSON.stringify(data), { status, headers: { "Content-Type": "application/json", ...getCorsHeaders5() } });
}
__name(jsonResponse4, "jsonResponse4");
__name2(jsonResponse4, "jsonResponse");
function errorResponse5(message, status) {
  return jsonResponse4({ status: "error", message }, status);
}
__name(errorResponse5, "errorResponse5");
__name2(errorResponse5, "errorResponse");
...
__name(getCorsHeaders5, "getCorsHeaders5");
__name2(getCorsHeaders5, "getCorsHeaders");
...
var onRequest6 = /* @__PURE__ */ __name2(async (context) => {
  ...
  try {
    ...
    if (!access_token || !shop_id) {
      return errorResponse6("access_token and shop_id are required", 400);
    }
    const partnerId = env.SHOPEE_PARTNER_ID;
    const partnerKey = env.SHOPEE_PARTNER_KEY;
    ...
    return new Response(JSON.stringify(data), {
      status: 200,
      headers: { "Content-Type": "application/json", ...getCorsHeaders6() }
    });
  } catch (error) {
    console.error("Add Item error:", error);
    return errorResponse6(`Server Error: ${error}`, 500);
  }
}, "onRequest");
...
__name(hmacSha2563, "hmacSha2563");
__name2(hmacSha2563, "hmacSha256");
...
__name(getCorsHeaders6, "getCorsHeaders6");
__name2(getCorsHeaders6, "getCorsHeaders");
...
__name(errorResponse6, "errorResponse6");
__name2(errorResponse6, "errorResponse");
...
var onRequest7 = /* @__PURE__ */ __name2(async (context) => {
  ...
  try {
    ...
    if (!accessToken || !shopId || !categoryId) {
      return errorResponse7("access_token, shop_id, and category_id are required", 400);
    }
    const partnerId = env.SHOPEE_PARTNER_ID;
    const partnerKey = env.SHOPEE_PARTNER_KEY;
    ...
    return new Response(JSON.stringify(data), {
      status: 200,
      headers: { "Content-Type": "application/json", ...getCorsHeaders7() }
    });
  } catch (error) {
    console.error("Attributes API error:", error);
    return errorResponse7(`Server Error: ${error}`, 500);
  }
}, "onRequest");
...
__name(hmacSha2564, "hmacSha2564");
__name2(hmacSha2564, "hmacSha256");
...
__name(getCorsHeaders7, "getCorsHeaders7");
__name2(getCorsHeaders7, "getCorsHeaders");
...
__name(errorResponse7, "errorResponse7");
__name2(errorResponse7, "errorResponse");
...
var onRequest8 = /* @__PURE__ */ __name2(async (context) => {
  ...
  try {
    ...
    if (!partnerId || !partnerKey) {
      return errorResponse8("\u74B0\u5883\u5909\u6570\u304C\u8A2D\u5B9A\u3055\u308C\u3066\u3044\u307E\u305B\u3093", 500);
    }
    const timestamp = Math.floor(Date.now() / 1e3);
    ...
    return errorResponse8(`\u30A8\u30E9\u30FC\u304C\u767A\u751F\u3057\u307E\u3057\u305F: ${error}`, 500);
  }
}, "onRequest");
...
__name(hmacSha2565, "hmacSha2565");
__name2(hmacSha2565, "hmacSha256");
...
__name(getCorsHeaders8, "getCorsHeaders8");
__name2(getCorsHeaders8, "getCorsHeaders");
...
__name(errorResponse8, "errorResponse8");
__name2(errorResponse8, "errorResponse");
...
var onRequest9 = /* @__PURE__ */ __name2(async (context) => {
  ...
  try {
    ...
    if (!accessToken || !shopId) {
      return errorResponse9("access_token and shop_id are required", 400);
    }
    const partnerId = env.SHOPEE_PARTNER_ID;
    const partnerKey = env.SHOPEE_PARTNER_KEY;
...
__name(hmacSha2566, "hmacSha2566");
__name2(hmacSha2566, "hmacSha256");
...
__name(getCorsHeaders9, "getCorsHeaders9");
__name2(getCorsHeaders9, "getCorsHeaders");
...
__name(errorResponse9, "errorResponse9");
__name2(errorResponse9, "errorResponse");
...
var onRequest10 = /* @__PURE__ */ __name2(async (context) => {
  ...
  if (request.method !== "POST") {
    return errorResponse10("Method not allowed", 405);
  }
  try {
    const body = await request.json();
    const { code, shop_id } = body;
    if (!code || !shop_id) {
      return errorResponse10("code and shop_id are required", 400);
    }
    ...
    if (tokenResult.error) {
      return errorResponse10(`Shopee API Error: ${tokenResult.error} - ${tokenResult.message || ""}`, 400);
    }
    ...
    return errorResponse10(`Server Error: ${error}`, 500);
  }
}, "onRequest");
...
__name2(saveTokenToD1, "saveTokenToD1");
...
__name(hmacSha2567, "hmacSha2567");
__name2(hmacSha2567, "hmacSha256");
...
__name(getCorsHeaders10, "getCorsHeaders10");
__name2(getCorsHeaders10, "getCorsHeaders");
...
__name(errorResponse10, "errorResponse10");
__name2(errorResponse10, "errorResponse");
...
var onRequest11 = /* @__PURE__ */ __name2(async (context) => {
  ...
  try {
    ...
    while (hasNextPage && allBrands.length < 1e4) {
      const url = `${SHOPEE_HOST8}${path}?partner_id=${partnerId}&timestamp=${timestamp}&access_token=${accessToken}&shop_id=${shopId}&sign=${sign}&category_id=${categoryId}&status=1&offset=${offset}&page_size=${pageSize}&language=en`;
    ...
    const sega = allBrands.find(
      (b) => b.display_brand_name?.toLowerCase() === "sega" || b.original_brand_name?.toLowerCase() === "sega"
    );
    return new Response(JSON.stringify({ sega, total: allBrands.length }, null, 2), {
      headers: { "Content-Type": "application/json" }
    });
  } catch (e) {
...
__name(hmacSha2568, "hmacSha2568");
__name2(hmacSha2568, "hmacSha256");
...
var onRequest12 = /* @__PURE__ */ __name2(async (context) => {
  ...
  try {
    ...
    if (!accessToken || !shopId || !itemId) {
      return errorResponse11("access_token, shop_id, and item_id are required", 400);
    }
    const partnerId = env.SHOPEE_PARTNER_ID;
    const partnerKey = env.SHOPEE_PARTNER_KEY;
    const path = "/api/v2/product/get_item_base_info";
    ...
    const apiUrl = `${SHOPEE_HOST9}${path}?partner_id=${partnerId}&timestamp=${timestamp}&access_token=${accessToken}&shop_id=${shopId}&sign=${sign}&item_id_list=${itemId}`;
    const response = await fetch(apiUrl, {
      method: "GET"
    });
    const data = await response.json();
...
__name(hmacSha2569, "hmacSha2569");
__name2(hmacSha2569, "hmacSha256");
...
__name(getCorsHeaders11, "getCorsHeaders11");
__name2(getCorsHeaders11, "getCorsHeaders");
...
__name(errorResponse11, "errorResponse11");
__name2(errorResponse11, "errorResponse");
var SHOPEE_HOST10 = "https://partner.shopeemobile.com";
var onRequest13 = /* @__PURE__ */ __name2(async (context) => {
  const { request, env } = context;
  if (request.method === "OPTIONS") {
    return new Response(null, { status: 204, headers: getCorsHeaders12() });
  }
  try {
    const url = new URL(request.url);
    const accessToken = url.searchParams.get("access_token");
    const shopId = url.searchParams.get("shop_id");
    if (!accessToken || !shopId) {
      return errorResponse12("access_token and shop_id are required", 400);
    }
    const partnerId = env.SHOPEE_PARTNER_ID;
    const partnerKey = env.SHOPEE_PARTNER_KEY;
    ...
    const apiUrl = `${SHOPEE_HOST10}${path}?partner_id=${partnerId}&timestamp=${timestamp}&access_token=${accessToken}&shop_id=${shopId}&sign=${sign}`;
    const response = await fetch(apiUrl, {
      method: "GET"
    });
    const data = await response.json();
...
__name(hmacSha25610, "hmacSha25610");
__name2(hmacSha25610, "hmacSha256");
...
__name(getCorsHeaders12, "getCorsHeaders12");
__name2(getCorsHeaders12, "getCorsHeaders");
...
__name(errorResponse12, "errorResponse12");
__name2(errorResponse12, "errorResponse");
...
async function getOrderList(partnerId, partnerKey, accessToken, shopId, timeFrom, timeTo, orderStatus, pageSize, cursor) {
  ...
  let apiUrl = `${SHOPEE_HOST11}${path}?partner_id=${partnerId}&timestamp=${timestamp}&sign=${sign}&access_token=${accessToken}&shop_id=${shopId}&time_range_field=create_time&time_from=${timeFrom}&time_to=${timeTo}&page_size=${pageSize}`;
...
__name2(getOrderList, "getOrderList");
async function getOrderDetail(partnerId, partnerKey, accessToken, shopId, orderSns) {
  ...
  const apiUrl = `${SHOPEE_HOST11}${path}?partner_id=${partnerId}&timestamp=${timestamp}&sign=${sign}&access_token=${accessToken}&shop_id=${shopId}&order_sn_list=${orderSnList}&response_optional_fields=buyer_username,item_list,recipient_address,note,message_to_seller`;
  const response = await fetch(apiUrl, {
    method: "GET",
    headers: { "Content-Type": "application/json" }
  });
...
__name2(getOrderDetail, "getOrderDetail");
...
__name2(mapOrderStatus, "mapOrderStatus");
...
__name(hmacSha25611, "hmacSha25611");
__name2(hmacSha25611, "hmacSha256");
...
__name(getCorsHeaders13, "getCorsHeaders13");
__name2(getCorsHeaders13, "getCorsHeaders");
...
async function getItemList2(partnerId, partnerKey, accessToken, shopId, offset, pageSize) {
  ...
  const apiUrl = `${SHOPEE_HOST12}${path}?partner_id=${partnerId}&timestamp=${timestamp}&sign=${sign}&access_token=${accessToken}&shop_id=${shopId}&offset=${offset}&page_size=${pageSize}&item_status=NORMAL&item_status=UNLIST`;
  const response = await fetch(apiUrl, {
    method: "GET",
    headers: { "Content-Type": "application/json" }
  });
...
__name(getItemList2, "getItemList2");
__name2(getItemList2, "getItemList");
async function getItemBaseInfo2(partnerId, partnerKey, accessToken, shopId, itemIds) {
  ...
  const sign = await hmacSha25612(partnerKey, baseString);
  const itemIdList = itemIds.join(",");
  const apiUrl = `${SHOPEE_HOST12}${path}?partner_id=${partnerId}&timestamp=${timestamp}&sign=${sign}&access_token=${accessToken}&shop_id=${shopId}&item_id_list=${itemIdList}&need_tax_info=false&need_complaint_policy=false`;
  const response = await fetch(apiUrl, {
    method: "GET",
    headers: { "Content-Type": "application/json" }
  });
...
__name(getItemBaseInfo2, "getItemBaseInfo2");
__name2(getItemBaseInfo2, "getItemBaseInfo");
...
__name2(mapItemStatus, "mapItemStatus");
...
__name(hmacSha25612, "hmacSha25612");
__name2(hmacSha25612, "hmacSha256");
...
__name(getCorsHeaders14, "getCorsHeaders14");
__name2(getCorsHeaders14, "getCorsHeaders");
...
async function getShopInfo(partnerId, partnerKey, accessToken, shopId) {
  ...
  const apiUrl = `${SHOPEE_HOST13}${path}?partner_id=${partnerId}&timestamp=${timestamp}&sign=${sign}&access_token=${accessToken}&shop_id=${shopId}`;
...
__name2(getShopInfo, "getShopInfo");
...
__name(hmacSha25613, "hmacSha25613");
__name2(hmacSha25613, "hmacSha256");
...
__name(getCorsHeaders15, "getCorsHeaders15");
__name2(getCorsHeaders15, "getCorsHeaders");
var SHOPEE_HOST14 = "https://partner.shopeemobile.com";
var onRequest17 = /* @__PURE__ */ __name2(async (context) => {
  const { request, env } = context;
  if (request.method === "OPTIONS") {
    return new Response(null, { status: 204, headers: getCorsHeaders16() });
  }
  if (request.method !== "POST") {
    return errorResponse13("Method not allowed", 405);
  }
  try {
    const body = await request.json();
    const { access_token, shop_id, item_id, update_type } = body;
    if (!access_token || !shop_id || !item_id) {
      return errorResponse13("access_token, shop_id, item_id are required", 400);
    }
    const partnerId = env.SHOPEE_PARTNER_ID;
    const partnerKey = env.SHOPEE_PARTNER_KEY;
    const results = {};
...
async function callShopeeApi(partnerId, partnerKey, accessToken, shopId, path, body) {
  ...
  const url = `${SHOPEE_HOST14}${path}?partner_id=${partnerId}&timestamp=${timestamp}&access_token=${accessToken}&shop_id=${shopId}&sign=${sign}`;
...
__name2(callShopeeApi, "callShopeeApi");
...
__name(hmacSha25614, "hmacSha25614");
__name2(hmacSha25614, "hmacSha256");
...
__name(getCorsHeaders16, "getCorsHeaders16");
__name2(getCorsHeaders16, "getCorsHeaders");
...
__name(errorResponse13, "errorResponse13");
__name2(errorResponse13, "errorResponse");
var SHOPEE_HOST15 = "https://partner.shopeemobile.com";
var onRequest18 = /* @__PURE__ */ __name2(async (context) => {
  const { request, env } = context;
  if (request.method === "OPTIONS") {
    return new Response(null, { status: 204, headers: getCorsHeaders17() });
  }
  if (request.method !== "POST") {
    return errorResponse14("Method not allowed", 405);
  }
  try {
    const url = new URL(request.url);
    const accessToken = url.searchParams.get("access_token");
    ...
    if (!image) {
      return errorResponse14("image file is required", 400);
    }
    const partnerId = env.SHOPEE_PARTNER_ID;
    const partnerKey = env.SHOPEE_PARTNER_KEY;
    ...
    const apiUrl = `${SHOPEE_HOST15}${path}?partner_id=${partnerId}&timestamp=${timestamp}&access_token=${accessToken}&shop_id=${shopId}&sign=${sign}`;
...
__name(hmacSha25615, "hmacSha25615");
__name2(hmacSha25615, "hmacSha256");
...
__name(getCorsHeaders17, "getCorsHeaders17");
__name2(getCorsHeaders17, "getCorsHeaders");
...
__name(errorResponse14, "errorResponse14");
__name2(errorResponse14, "errorResponse");
var SHOPEE_HOST16 = "https://partner.shopeemobile.com";
...
__name(saveTokenToD12, "saveTokenToD12");
__name2(saveTokenToD12, "saveTokenToD1");
async function getAccessToken2(partnerId, partnerKey, code, shopId) {
  const timestamp = Math.floor(Date.now() / 1e3);
  const path = "/api/v2/auth/token/get";
  const baseString = `${partnerId}${path}${timestamp}`;
  const sign = await hmacSha25616(partnerKey, baseString);
  const tokenUrl = `${SHOPEE_HOST16}${path}?partner_id=${partnerId}&timestamp=${timestamp}&sign=${sign}`;
  const response = await fetch(tokenUrl, {
    method: "POST",
    headers: {
      "Content-Type": "application/json"
...
async function hmacSha25616(key, message) {
  const encoder = new TextEncoder();
  const keyData = encoder.encode(key);
  const messageData = encoder.encode(message);
  const cryptoKey = await crypto.subtle.importKey(
...
__name(hmacSha25616, "hmacSha25616");
__name2(hmacSha25616, "hmacSha256");
...
__name2(generateSuccessHtml, "generateSuccessHtml");
...
__name2(generateErrorHtml, "generateErrorHtml");
...
__name(getCorsHeaders18, "getCorsHeaders18");
__name2(getCorsHeaders18, "getCorsHeaders");
var routes = [
  {
  ...
  {
    routePath: "/api/shopee/find_sega",
    mountPath: "/api/shopee",
    method: "",
    middlewares: [],
    modules: [onRequest11]
...
// .wrangler/tmp/bundle-KSTxXi/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-KSTxXi/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.19698211825969403.js.map
