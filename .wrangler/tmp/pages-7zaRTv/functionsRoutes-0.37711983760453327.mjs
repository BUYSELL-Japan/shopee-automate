...
import { onRequest as __api_shopee_find_sega_ts_onRequest } from "C:\\Users\\buyse\\OneDrive\\デスクトップ\\Antigravity\\Shopee Auto\\project\\functions\\api\\shopee\\find_sega.ts"
...
export const routes = [
    ...
    },
  {
      ...
      method: "",
      middlewares: [],
      modules: [__api_shopee_find_sega_ts_onRequest],
    },
  {
