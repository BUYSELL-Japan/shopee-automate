...
import { onRequest as __api_db_order_costs_ts_onRequest } from "C:\\Users\\buyse\\OneDrive\\デスクトップ\\Antigravity\\Shopee Auto\\project\\functions\\api\\db\\order-costs.ts"
...
import { onRequest as __api_db_region_settings_ts_onRequest } from "C:\\Users\\buyse\\OneDrive\\デスクトップ\\Antigravity\\Shopee Auto\\project\\functions\\api\\db\\region-settings.ts"
import { onRequest as __api_db_shops_ts_onRequest } from "C:\\Users\\buyse\\OneDrive\\デスクトップ\\Antigravity\\Shopee Auto\\project\\functions\\api\\db\\shops.ts"
...
export const routes = [
    ...
    },
  {
      ...
      method: "",
      middlewares: [],
      modules: [__api_db_order_costs_ts_onRequest],
    },
  {
    ...
    },
  {
      ...
      method: "",
      middlewares: [],
      modules: [__api_db_region_settings_ts_onRequest],
    },
  {
      ...
      method: "",
      middlewares: [],
      modules: [__api_db_shops_ts_onRequest],
    },
  {
